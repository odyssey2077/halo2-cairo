...
pub struct DecodedInstruction<F: ScalarField> {
    pub off_dst: AssignedValue<F>,
    pub off_op0: AssignedValue<F>,
    pub off_op1: AssignedValue<F>,
    pub dst_reg: AssignedValue<F>,
    pub op0_reg: AssignedValue<F>,
    pub op1_src: AssignedValue<F>,
    pub res_logic: AssignedValue<F>,
    pub pc_update: AssignedValue<F>,
    pub ap_update: AssignedValue<F>,
    pub op_code: AssignedValue<F>,
}
